...
experience5 = Experience.create!(name: "Concert Esy Kennanga B", description: "Concert muet ", address: "Fort-de-France", date: '22/03/2022', capacity: 2, price: 40, host: user5 )
