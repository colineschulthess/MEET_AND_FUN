...
experience5 = Experience.create!(name: "Concert Esy Kennanga B", description: "Concert muet ", address: "Fort-de-France, Martinique", date: '22/03/2022', capacity: 2, price: 40, host: user5 )
...
experience9 = Experience.create!(name: "After Work", description: "On friday we all talk in english  ", address: "LAKOU Fort-de-France, Martinique", date: '18/03/2022', capacity: 50, price: 5, host: user9 )
